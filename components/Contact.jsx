    ...
    <section className="c-space my-0 mb-20 sm:my-20" id="contact">
      ...
      <div className="relative min-h-screen flex items-center justify-center flex-col">
        ...
        <div className="contact-container text-white-600 ">
          ...
          <p className="text-lg mt-3">Egal, ob du eine neue Webseite erstellen, optimieren oder ein einzigartiges Projekt verwirklichen möchtest – ich helfe gerne.</p>
          <form ref={formRef} onSubmit={handleSubmit} className="mt-12 flex flex-col space-y-7">
            <label className="space-y-3">
              <span className="field-label">Vollständiger Name</span>
              <input type="text" name="name" value={form.name} onChange={handleChange} required className="field-input" placeholder="z.B. John Doe" />
            </label>
            <label className="space-y-3">
              <span className="field-label">E-Mail-Adresse</span>
              <input type="email" name="email" value={form.email} onChange={handleChange} required className="field-input" placeholder="z.B. johndoe@gmail.com" />
            </label>
            <label className="space-y-3">
              <span className="field-label">Deine Nachricht</span>
              <textarea name="message" value={form.message} onChange={handleChange} required rows={5} className="field-input" placeholder="Teile deine Gedanken oder Anfragen..." />
            </label>
