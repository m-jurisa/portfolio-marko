...
const sections = [
  {
    ...
    items: [
      ...
      item('/assets/icons/icon-nextjs.webp', 'Next.js'),
      ...
      item('/assets/icons/icon-figma.webp', 'Figma'),
    ],
  },
  {
    title: 'Backend',
    items: [
      item('/assets/icons/icon-go.webp', 'Go'),
      item('/assets/javascript.png', 'JavaScript'),
      item('/assets/icons/icon-csharp.webp', 'C#'),
      item('/assets/icons/icon-python.webp', 'Python'),
      item('/assets/icons/icon-node.webp', 'Node.js'),
      item('/assets/icons/icon-mysql.webp', 'MySQL'),
      item('/assets/icons/icon-postgress.webp', 'PostgreSQL'),
      item('/assets/icons/icon-sqlite.webp', 'SQLite'),
    ],
  },
  {
    title: 'Video & Photo',
    items: [
      item('/assets/icons/icon-aftereffects.webp', 'After Effects'),
