...
export const skillsData = [
  { name: 'After Effects', logo: '/assets/cards/card-img-after-effects.webp', alt: 'Adobe After Effects', percentage: 10 },
  { name: 'Blender', logo: '/assets/cards/card-img-blender.webp', alt: 'Blender 3D Modeling Software', percentage: 15 },
  { name: 'ClickUp', logo: '/assets/cards/card-img-click-up.webp', alt: 'ClickUp Project Management Tool', percentage: 30 },
  { name: 'CSS3', logo: '/assets/cards/card-img-css.webp', alt: 'CSS3 Stylesheet Language', percentage: 40 },
  ...
  { name: 'GitHub', logo: '/assets/cards/card-img-github.webp', alt: 'GitHub Version Control', percentage: 15 },
  { name: 'HTML5', logo: '/assets/cards/card-img-html.webp', alt: 'HTML5 Web Markup Language', percentage: 50 },
  { name: 'Illustrator', logo: '/assets/cards/card-img-illustrator.webp', alt: 'Adobe Illustrator', percentage: 20 },
  { name: 'JavaScript', logo: '/assets/cards/card-img-javascript.webp', alt: 'JavaScript Programming Language', percentage: 12 },
  { name: 'Jira', logo: '/assets/cards/card-img-jira.webp', alt: 'Jira Project Management Tool', percentage: 25 },
  { name: 'MySQL', logo: '/assets/cards/card-img-mysql.webp', alt: 'MySQL Database Management System', percentage: 25 },
  { name: 'Node.js', logo: '/assets/cards/card-img-nodejs.webp', alt: 'Node.js JavaScript Runtime', percentage: 15 },
  { name: 'Photoshop', logo: '/assets/cards/card-img-photoshop.webp', alt: 'Adobe Photoshop', percentage: 60 },
  { name: 'Premiere Pro', logo: '/assets/cards/card-img-premiere-pro.webp', alt: 'Adobe Premiere Pro', percentage: 20 },
  { name: 'Prusa Slicer', logo: '/assets/cards/card-img-prusa-slicer.webp', alt: 'Prusa Slicer 3D Printing Software', percentage: 40 },
  { name: 'Python', logo: '/assets/cards/card-img-python.webp', alt: 'Python Programming Language', percentage: 5 },
  { name: 'React', logo: '/assets/cards/card-img-react.webp', alt: 'React JavaScript Library', percentage: 17 },
